        ...
        <div className="sectStart">
            ...
            <div className="processSect sects">
                <div className="left">
                    ...
                    <div className="aptxt">
                        <h4> <b>1. In-home design consultation</b> </h4>
                        <p className="body">
                ...
                <div className="right">
                    ...
                    <div className="aptxt">
                        <h4> <b>2. Design retainer presentation</b> </h4>
                        <p className="body">
            ...
            <div className="processSect sects">
                <div className="left">
                    ...
                    <div className="aptxt">
                        <h4> <b>3.  Design and VEC meeting</b> </h4>
                        <p className="body">
                ...
                <div className="right">
                    ...
                    <div className="aptxt">
                        <h4> <b>4.  Design and bid presentation</b> </h4>
                        <p className="body">
            ...
            <div className="processSect sects">
                ...
                <div className="right">
                    ...
                    <div className="aptxt">
                        <h4> <b>6.  Architectural engineering</b> </h4>
                        <p className="body">
            ...
            <div className="processSect sects">
                ...
                <div className="right">
                    ...
                    <div className="aptxt">
                        <h4> <b>8.  Pre Construction Meeting & Starting the Remodel</b> </h4>
                        <p className="body">
            ...
            <div className="processSect sects">
                <div className="left">
                    ...
                    <div className="aptxt">
                        <h4> <b>9. Project in construction</b> </h4>
                        <p className="body">
